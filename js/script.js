...
bottone.addEventListener('click', function(){
    ...
    if (isNaN(numberKmUser.value) || isNaN(numberAgeUser.value) || numberKmUser.value <= 0 || numberAgeUser.value <= 0 || numberAgeUser.value > 150) {
        ...
        prezzoBigliettoHone.innerHTML += ('<div class="card my_grandezza_card mb-3">' + '<img src="./img/1.jpg" class="card-img-top img-thumbnail" alt="treno">' + '<div class="card-body">' + '<p class="card-text">Il prezzo del tuo biglietto</p>' + '</div>' + '<ul class="list-group list-group-flush">' + '<li class="list-group-item">' + 'Prezzo: ' + priceTicket.toFixed(2) + '€' + '</li>' + '<li class="list-group-item">' + 'La tua età: ' + numberAgeUser.value + ' anni' + '</li>' + '<li class="list-group-item">' + 'I chilometri che devi percorrere: ' + numberKmUser.value + 'Km' + '</li>' + '</ul>' + '</div>');
